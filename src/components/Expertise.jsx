        ...
        >
          <div className="flex text-white justify-center ">
            ...
            <div className="w-2/3 text-center space-y-3">
              ...
              <p>
              Love This Technologies that defines my Skills. I have a strong foundation Java , Spring Boot , RestFul Webservices, Hibernate/JPA ,MySQl..
              </p>
          ...
          <div className="flex justify-center">
            ...
            <div className="flex justify-center w-2/3 h-fit space-x-3  flex-wrap ml-40">
